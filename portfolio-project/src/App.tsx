...
function App() {
  return (
    <>
      ...
      <div className="relative z-10 min-h-screen overflow-y-auto" id="portfolio-content">
        ...
        <section id="about" className="min-h-screen flex items-center justify-center px-6 py-24">
          <div className="glass-card max-w-3xl w-full p-8 md:p-12">
            <h2 className="font-pixel text-xl text-cyan-400 mb-6 flex items-center gap-3">
              <span className="text-purple-400">01.</span> ABOUT ME
            </h2>
            <div className="space-y-4 font-body text-gray-300 leading-relaxed">
              <p>
